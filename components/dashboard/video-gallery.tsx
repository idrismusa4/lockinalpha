...
function VideoCard({ video }: { video: any }) {
  ...
  return (
    <motion.div
      className="group relative rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 transition-all hover:shadow-md"
      whileHover={{
        scale: 1.03,
